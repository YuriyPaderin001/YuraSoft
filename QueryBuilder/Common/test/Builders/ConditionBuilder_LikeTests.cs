...
namespace YuraSoft.QueryBuilder.Common.Tests.Builders
{
	...
	{
		#region + Like(column: string, pattern: string): ConditionBuilder
		...
		public void Like_StringAndString_Success(string column, string pattern)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, pattern);
			...
			LikeCondition likeCondition = Assert.IsType<LikeCondition>(buildedCondition);
		...
		#endregion + Like(column: string, pattern: string): ConditionBuilder

		#region + Like(column: string, patternFunction: Func<ExpressionFactory, IExpression>): ConditionBuilder
		...
		public void Like_StringAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, patternFunction);
		...
		#endregion + Like(column: string, patternFunction: Func<ExpressionFactory, IExpression>): ConditionBuilder

		#region + Like(column: string, pattern: IExpression): ConditionBuilder
		...
		#endregion + Like(column: string, pattern: IExpression): ConditionBuilder

		#region + Like(column: string, table: string | null, pattern: string): ConditionBuilder
		...
		public void Like_StringAndStringAndString_Success(string column, string table, string pattern)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, table, pattern);
		...
		public void Like_StringAndNullStringAndString_Success(string column, string pattern)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, table: null, pattern);
		...
		#endregion + Like(column: string, table: string | null, pattern: string): ConditionBuilder

		#region + Like(column: string, table: string | null, patternFunction: Func<ExpressionFactory, IExpression>): ConditionBuilder
		...
		public void Like_StringAndStringAndFuncExpressionFactoryIExpression_Success(string column, string table)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, table, patternFunction);
		...
		#endregion + Like(column: string, table: string | null, patternFunction: Func<ExpressionFactory, IExpression>): ConditionBuilder

		#region + Like(column: string, table: string | null, pattern: IExpression): ConditionBuilder
		...
		#endregion + Like(column: string, table: string | null, pattern: IExpression): ConditionBuilder

		#region + Like(column: string, source: ISource | null, pattern: string): ConditionBuilder
		...
		public void Like_StringAndISourceAndString_Success(string column, string pattern)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, source, pattern);
		...
		#endregion + Like(column: string, source: ISource | null, pattern: string): ConditionBuilder

		#region + Like(column: string, source: ISource | null, pattern: Func<ExpressionFactory, IExpression>): ConditionBuilder
		...
		public void Like_StringAndISourceAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, source, patternFunction);
		...
		public void Like_StringAndNullISourceAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, source: null, patternFunction);
		...
		#endregion + Like(column: string, source: ISource | null, pattern: Func<ExpressionFactory, IExpression>): ConditionBuilder

		#region + Like(column: string, source: ISource | null, pattern: IExpression): ConditionBuilder
		...
		public void Like_StringAndNullISourceAndIExpression_Success(string column)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(column, source: null, pattern);
		...
		#endregion + Like(column: string, source: ISource | null, pattern: IExpression): ConditionBuilder

		#region + Like(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: string): ConditionBuilder
		...
		public void Like_FuncExpressionFactoryIExpressionAndString_Success(string pattern)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(expressionFunction, pattern);
		...
		#endregion + Like(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: string): ConditionBuilder

		#region + Like(expressionFunction: Func<ExpressionFactory, IExpression>, patternFunction: Func<ExpressionFactory, IExpression>): ConditionBuilder
		...
		public void Like_FuncExpressionFactoryIExpressionAndFuncExpressionFactoryIExpression_Success()
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(expressionFunction, patternFunction);
		...
		#endregion + Like(expressionFunction: Func<ExpressionFactory, IExpression>, patternFunction: Func<ExpressionFactory, IExpression>): ConditionBuilder

		#region + Like(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: IExpression): ConditionBuilder
		...
		#endregion + Like(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: IExpression): ConditionBuilder

		#region + Like(expression: IExpression, pattern: string): ConditionBuilder
		...
		public void Like_IExpressionAndString_Success(string pattern)
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(expression, pattern);
		...
		#endregion + Like(expression: IExpression, pattern: string): ConditionBuilder

		#region + Like(expression: IExpression, patternFunction: Func<ExpressionFactory, IExpression>): ConditionBuilder
		...
		public void Like_IExpressionAndFuncExpressionFactoryIExpression_Success()
		{
			...
			// Act
			ConditionBuilder configuredConditionBuilder = conditionBuilder.Like(expression, patternFunction);
		...
		#endregion + Like(expression: IExpression, patternFunction: Func<ExpressionFactory, IExpression>): ConditionBuilder

		#region + Like(expression: IExpression, pattern: IExpression): ConditionBuilder
		...
		#endregion + Like(expression: IExpression, pattern: IExpression): ConditionBuilder

		private void Like_ThrowsException<TException>(Action<ConditionBuilder> buildFunction) where TException : Exception
		{
			// Arrange
			ConditionBuilder conditionBuilder = new ConditionBuilder();
