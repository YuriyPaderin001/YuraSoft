...
namespace YuraSoft.QueryBuilder.Common.Tests.Builders
{
	...
	{
		#region + Like(column: string, pattern: string): ExpressionBuilder
		...
		public void Like_StringAndString_Success(string column, string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, pattern);

			// Assert
			Assert.NotNull(configuredExpressionBuilder);
			Assert.Equal(expressionBuilder, configuredExpressionBuilder);

			IExpression buildedExpression = Assert.Single(configuredExpressionBuilder.Build());

			Assert.NotNull(buildedExpression);

			LikeCondition likeCondition = Assert.IsType<LikeCondition>(buildedExpression);
		...
		public void Like_StringAndNullString_ThrowsArgumentNullException(string? column, string? pattern) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column!, pattern!));
		...
		public void Like_NullOrEmptyStringAndString_ThrowsArgumentException(string? column, string? pattern) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, pattern!));

		#endregion + Like(column: string, pattern: string): ExpressionBuilder

		#region + Like(column: string, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void Like_StringAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, patternFunction);
		...
		public void Like_StringAndNullFuncExpressionFactoryIExpression_ThrowsArgumentNullException(string column) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column, patternFunction: null!));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndFuncExpressionFactoryIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, patternFunction: (_) => NewExpression()));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndNullFuncExpressionFactoryIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, patternFunction: null!));

		#endregion + Like(column: string, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + Like(column: string, pattern: IExpression): ExpressionBuilder
		...
		public void Like_StringAndNullIExpression_ThrowsArgumentNullException(string column) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column, pattern: (IExpression)null!));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, pattern: NewExpression()));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndNullIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, pattern: (IExpression)null!));

		#endregion + Like(column: string, pattern: IExpression): ExpressionBuilder

		#region + Like(column: string, table: string | null, pattern: string): ExpressionBuilder
		...
		public void Like_StringAndStringAndString_Success(string column, string table, string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, table, pattern);
		...
		public void Like_StringAndNullStringAndString_Success(string column, string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, table: null, pattern);
		...
		public void Like_StringAndStringAndString_ThrowsArgumentNullException(string? column, string? table, string? pattern) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column!, table, pattern!));
		...
		public void Like_StringAndStringAndString_ThrowsArgumentException(string? column, string? table, string? pattern) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, table, pattern!));

		#endregion + Like(column: string, table: string | null, pattern: string): ExpressionBuilder

		#region + Like(column: string, table: string | null, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void Like_StringAndStringAndFuncExpressionFactoryIExpression_Success(string column, string table)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, table, patternFunction);
		...
		public void Like_StringAndStringAndNullFuncExpressionFactoryIExpression_ThrowsArgumentNullException(string column, string table) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column, table, patternFunction: null!));
		...
		public void Like_NullOrEmptyStringAndStringAndFuncExpressionFactoryIExpression_ThrowsArgumentException(string? column, string table) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, table, patternFunction: (_) => NewExpression()));
		...
		public void Like_NullOrEmptyStringAndStringAndNullFuncExpressionFactoryIExpression_ThrowsArgumentException(string? column, string table) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, table, patternFunction: null!));
		...
		#endregion + Like(column: string, table: string | null, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + Like(column: string, table: string | null, pattern: IExpression): ExpressionBuilder
		...
		public void Like_StringAndStringAndIExpression_ThrowsArgumentNullException(string column, string table) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column, table, pattern: (IExpression)null!));
		...
		public void Like_NullOrEmptyStringAndStringAndIExpression_ThrowsArgumentException(string? column, string table) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, table, pattern: (IExpression)null!));
		...
		#endregion + Like(column: string, table: string | null, pattern: IExpression): ExpressionBuilder

		#region + Like(column: string, source: ISource | null, pattern: string): ExpressionBuilder
		...
		public void Like_StringAndISourceAndString_Success(string column, string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, source, pattern);
		...
		public void Like_StringAndISourceAndString_ThrowsArgumentNullException(string? column, string? pattern) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column!, source: NewSource(), pattern!));

		[Theory]
		[InlineData("column_1", null)]
		public void Like_StringAndNullISourceAndString_ThrowsArgumentNullException(string? column, string? pattern) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column!, source: null, pattern!));
		...
		public void Like_StringAndISourceAndString_ThrowsArgumentException(string? column, string? pattern) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: NewSource(), pattern!));
		...
		public void Like_StringAndNullISourceAndString_ThrowsArgumentException(string? column, string? pattern) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: null, pattern!));

		#endregion + Like(column: string, source: ISource | null, pattern: string): ExpressionBuilder

		#region + Like(column: string, source: ISource | null, pattern: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void Like_StringAndISourceAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, source, patternFunction);
		...
		public void Like_StringAndNullISourceAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, source: null, patternFunction);
		...
		public void Like_StringAndISourceAndNullFuncExpressionFactoryIExpression_ThrowsArgumentNullException(string column) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column, source: NewSource(), patternFunction: null!));

		[Theory]
		[InlineData("column_1")]
		public void Like_StringAndNullISourceAndNullFuncExpressionFactoryIExpression_ThrowsArgumentNullException(string column) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column, source: null!, patternFunction: null!));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndISourceAndFuncExpressionFactoryIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: NewSource(), patternFunction: (_) => NewExpression()));
		...
		public void Like_NullOrEmptyStringAndNullISourceAndFuncExpressionFactoryIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: null!, patternFunction: (_) => NewExpression()));
		...
		public void Like_NullOrEmptyStringAndISourceAndNullFuncExpressionFactoryIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: NewSource(), patternFunction: null!));
		...
		public void Like_NullOrEmptyStringAndNullISourceAndNullFuncExpressionFactoryIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: null!, patternFunction: null!));

		#endregion + Like(column: string, source: ISource | null, pattern: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + Like(column: string, source: ISource | null, pattern: IExpression): ExpressionBuilder
		...
		public void Like_StringAndNullISourceAndIExpression_Success(string column)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(column, source: null, pattern);
		...
		public void Like_StringAndISourceAndNullIExpression_ThrowsArgumentNullException(string column) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column, source: NewSource(), pattern: (IExpression)null!));

		[Theory]
		[InlineData("column_1")]
		public void Like_StringAndNullISourceAndNullIExpression_ThrowsArgumentNullException(string column) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(column, source: null, pattern: (IExpression)null!));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndISourceAndIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: NewSource(), pattern: NewExpression()));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndNullISourceAndIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: null, pattern: NewExpression()));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndISourceAndNullIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: NewSource(), pattern: (IExpression)null!));

		[Theory]
		[InlineData(null)]
		[InlineData("")]
		public void Like_NullOrEmptyStringAndNullISourceAndNullIExpression_ThrowsArgumentException(string? column) =>
			Like_ThrowsException<ArgumentException>(builder => builder.Like(column!, source: null, pattern: (IExpression)null!));

		#endregion + Like(column: string, source: ISource | null, pattern: IExpression): ExpressionBuilder

		#region + Like(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: string): ExpressionBuilder
		...
		public void Like_FuncExpressionFactoryIExpressionAndString_Success(string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(expressionFunction, pattern);
		...
		public void Like_FuncExpressionFactoryIExpressionAndNullString_ThrowsArgumentNullException() =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like((_) => NewExpression(), pattern: (string?)null!));
		...
		public void Like_NullFuncExpressionFactoryIExpressionAndString_ThrowsArgumentNullException(string? pattern) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(expressionFunction: null!, pattern!));

		#endregion + Like(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: string): ExpressionBuilder

		#region + Like(expressionFunction: Func<ExpressionFactory, IExpression>, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void Like_FuncExpressionFactoryIExpressionAndFuncExpressionFactoryIExpression_Success()
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(expressionFunction, patternFunction);
		...
		public void Like_FuncExpressionFactoryIExpressionAndNullFuncExpressionFactoryIExpression_ThrowsArgumentNullException() =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(
		...
		#endregion + Like(expressionFunction: Func<ExpressionFactory, IExpression>, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + Like(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: IExpression): ExpressionBuilder
		...
		#endregion + Like(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: IExpression): ExpressionBuilder

		#region + Like(expression: IExpression, pattern: string): ExpressionBuilder
		...
		public void Like_IExpressionAndString_Success(string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(expression, pattern);
		...
		public void Like_IExpressionAndNullString_ThrowsArgumentNullException() =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(expression: NewExpression(), pattern: (string?)null!));
		...
		public void Like_NullIExpressionAndString_ThrowsArgumentNullException(string? pattern) =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(expression: null!, pattern!));

		#endregion + Like(expression: IExpression, pattern: string): ExpressionBuilder

		#region + Like(expression: IExpression, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void Like_IExpressionAndFuncExpressionFactoryIExpression_Success()
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.Like(expression, patternFunction);
		...
		public void Like_NullIExpressionAndNullFuncExpressionFactoryIExpression_ThrowsArgumentNullException() =>
			Like_ThrowsException<ArgumentNullException>(builder => builder.Like(expression: null!, patternFunction: null!));

		#endregion + Like(expression: IExpression, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + Like(expression: IExpression, pattern: IExpression): ExpressionBuilder
		...
		#endregion + Like(expression: IExpression, pattern: IExpression): ExpressionBuilder

		private void Like_ThrowsException<TException>(Action<ExpressionBuilder> buildFunction) where TException : Exception
		{
			// Arrange
			ExpressionBuilder expressionBuilder = new ExpressionBuilder();
