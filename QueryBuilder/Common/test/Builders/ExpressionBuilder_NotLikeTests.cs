...
namespace YuraSoft.QueryBuilder.Common.Tests.Builders
{
	...
	{
		#region + NotLike(column: string, pattern: string): ExpressionBuilder
		...
		public void NotLike_StringAndString_Success(string column, string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, pattern);
			...
			NotLikeCondition notLikeCondition = Assert.IsType<NotLikeCondition>(buildedExpression);
		...
		#endregion + NotLike(column: string, pattern: string): ExpressionBuilder

		#region + NotLike(column: string, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void NotLike_StringAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, patternFunction);
		...
		#endregion + NotLike(column: string, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + NotLike(column: string, pattern: IExpression): ExpressionBuilder
		...
		#endregion + NotLike(column: string, pattern: IExpression): ExpressionBuilder

		#region + NotLike(column: string, table: string | null, pattern: string): ExpressionBuilder
		...
		public void NotLike_StringAndStringAndString_Success(string column, string table, string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, table, pattern);
		...
		public void NotLike_StringAndNullStringAndString_Success(string column, string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, table: null, pattern);
		...
		#endregion + NotLike(column: string, table: string | null, pattern: string): ExpressionBuilder

		#region + NotLike(column: string, table: string | null, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void NotLike_StringAndStringAndFuncExpressionFactoryIExpression_Success(string column, string table)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, table, patternFunction);
		...
		#endregion + NotLike(column: string, table: string | null, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + NotLike(column: string, table: string | null, pattern: IExpression): ExpressionBuilder
		...
		#endregion + NotLike(column: string, table: string | null, pattern: IExpression): ExpressionBuilder

		#region + NotLike(column: string, source: ISource | null, pattern: string): ExpressionBuilder
		...
		public void NotLike_StringAndISourceAndString_Success(string column, string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, source, pattern);
		...
		#endregion + NotLike(column: string, source: ISource | null, pattern: string): ExpressionBuilder

		#region + NotLike(column: string, source: ISource | null, pattern: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void NotLike_StringAndISourceAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, source, patternFunction);
		...
		public void NotLike_StringAndNullISourceAndFuncExpressionFactoryIExpression_Success(string column)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, source: null, patternFunction);
		...
		#endregion + NotLike(column: string, source: ISource | null, pattern: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + NotLike(column: string, source: ISource | null, pattern: IExpression): ExpressionBuilder
		...
		public void NotLike_StringAndNullISourceAndIExpression_Success(string column)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(column, source: null, pattern);
		...
		#endregion + NotLike(column: string, source: ISource | null, pattern: IExpression): ExpressionBuilder

		#region + NotLike(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: string): ExpressionBuilder
		...
		public void NotLike_FuncExpressionFactoryIExpressionAndString_Success(string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(expressionFunction, pattern);
		...
		#endregion + NotLike(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: string): ExpressionBuilder

		#region + NotLike(expressionFunction: Func<ExpressionFactory, IExpression>, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void NotLike_FuncExpressionFactoryIExpressionAndFuncExpressionFactoryIExpression_Success()
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(expressionFunction, patternFunction);
		...
		#endregion + NotLike(expressionFunction: Func<ExpressionFactory, IExpression>, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + NotLike(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: IExpression): ExpressionBuilder
		...
		#endregion + NotLike(expressionFunction: Func<ExpressionFactory, IExpression>, pattern: IExpression): ExpressionBuilder

		#region + NotLike(expression: IExpression, pattern: string): ExpressionBuilder
		...
		public void NotLike_IExpressionAndString_Success(string pattern)
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(expression, pattern);
		...
		#endregion + NotLike(expression: IExpression, pattern: string): ExpressionBuilder

		#region + NotLike(expression: IExpression, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder
		...
		public void NotLike_IExpressionAndFuncExpressionFactoryIExpression_Success()
		{
			...
			// Act
			ExpressionBuilder configuredExpressionBuilder = expressionBuilder.NotLike(expression, patternFunction);
		...
		#endregion + NotLike(expression: IExpression, patternFunction: Func<ExpressionFactory, IExpression>): ExpressionBuilder

		#region + NotLike(expression: IExpression, pattern: IExpression): ExpressionBuilder
		...
		#endregion + NotLike(expression: IExpression, pattern: IExpression): ExpressionBuilder

		private void NotLike_ThrowsException<TException>(Action<ExpressionBuilder> buildFunction) where TException : Exception
		{
			// Arrange
			ExpressionBuilder expressionBuilder = new ExpressionBuilder();
