...
{
	public class MinWindowFunction : ExpressionWindowFunction
	{
		public MinWindowFunction(IExpression expression, ICondition? filter, List<IColumn>? partitionBy, List<IOrderBy>? orderBy)
